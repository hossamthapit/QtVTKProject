...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_8->setGeometry(QRect(820, 520, 101, 20));
        ...
        lineEdit_Rotare = new QLineEdit(centralwidget);
        lineEdit_Rotare->setObjectName("lineEdit_Rotare");
        lineEdit_Rotare->setGeometry(QRect(820, 340, 201, 28));
        ...
        btnOpacity->setGeometry(QRect(1030, 540, 41, 29));
        ...
        btnFlip->setGeometry(QRect(820, 480, 251, 29));
        btnSave = new QPushButton(centralwidget);
        btnSave->setObjectName("btnSave");
        btnSave->setGeometry(QRect(820, 650, 121, 29));
        btnLoad = new QPushButton(centralwidget);
        btnLoad->setObjectName("btnLoad");
        btnLoad->setGeometry(QRect(950, 650, 121, 29));
